...
#include "GrenadeBehavior_PayloadTransfusion.generated.h"
...
class OAKGAME_API UGrenadeBehavior_PayloadTransfusion : public UGrenadeBehavior_PayloadBlueprint {
    GENERATED_BODY()
public:
protected:
...
public:
    UGrenadeBehavior_PayloadTransfusion();
};
