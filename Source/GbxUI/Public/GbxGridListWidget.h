...
#include "EGbxListWrapMode.h"
#include "EGbxGridWidgetFill.h"
#include "EGbxFocusableWidgetMouseBehavior.h"
#include "EGbxListFocusChangedAction.h"
#include "EGbxFocusableWidgetState.h"
#include "GbxGridListWidget.generated.h"
...
UCLASS()
class GBXUI_API UGbxGridListWidget : public UGridPanel, public IGbxList, public IGbxFocusableWidget {
    GENERATED_BODY()
public:
    UPROPERTY(Transient)
    ...
    UPROPERTY(EditAnywhere)
    EGbxListWrapMode RowWrapMode;
    
    UPROPERTY(EditAnywhere)
    EGbxListWrapMode ColumnWrapMode;
    ...
    UPROPERTY(EditAnywhere)
    EGbxListFocusChangedAction FocusChangeAction;
